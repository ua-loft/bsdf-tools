...
hold on
grid on
title('Corrected BRDF Data for Aeroglaze Z307 (12"x12") [Jacob K, 2026/08/11]')
ylabel('BRDF')
...
%     'Location', 'northwest')
legend('Incidence 10°', 'Incidence 70°', ...
    'Location', 'northwest')
