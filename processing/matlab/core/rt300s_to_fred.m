...
% Measured sample(s):
S = 0 : 10: 90; % stage rotation [deg]; if isotropic set to integer 0, 
...
ISOTROPIC = false; % set true if sample is isotropic
ANISO_W_XZ_SYMM = true; % set true if sample is anisotropic but exhibits 
...
ANISO_W_YZ_SYMM = true; % same, but for XZ plane
